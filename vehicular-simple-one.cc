...
int main (int argc, char *argv[])
{
  ...
  uint32_t endTime = 20000; // application end time in milliseconds
  uint32_t interPacketInterval = 5000; // interpacket interval in microseconds
  ...
  double antennaHeight = 0.5; // the height of the antenna
  ...
  std::cout << "Time Delay:\t\t" << double(g_lastReceived.GetSeconds() - g_firstReceived.GetSeconds()) << " seconds" << std::endl;
