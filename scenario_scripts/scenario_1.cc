...
//
// scenrio_1: 2 vehicles moving at constant speed; communicating via a 5G V2V connection in UDP 
//  
// description: This script creates two nodes moving at 20 m/s, placed at a distance of 10 m.
...
int main (int argc, char *argv[])
{
  ...
  n.Get (0)->GetObject<MobilityModel> ()->SetPosition (Vector (-intraGroupDistance,-2.5,antennaHeight));
...
/*
Adding flow monitor to listen to nodes
...
*/
  ...
  */
  Ptr<Node> ptrtonode1 = n.Get (1);
  Ptr<Node> ptrtonode0 = n.Get (0);
